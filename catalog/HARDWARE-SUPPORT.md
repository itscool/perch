...
| LG 27UL850-W · UL850 firmware (tested here) | HDMI 1 = 17, HDMI 2 = 18, DisplayPort = 15 (standard command), USB-C = 209 (LG command) |
| LG 27UP850-W | HDMI 1 = 144, HDMI 2 = 145, DisplayPort = 208, USB-C = 209 |
| LG 27UP850-W · UP850K firmware (tested here) | HDMI 1 = 17, HDMI 2 = 18, DisplayPort = 15 (standard command), USB-C = 209 (LG command) |
