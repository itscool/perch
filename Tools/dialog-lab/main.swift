...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    @objc func configureSettings() {
        ...
        let actions: [(String, () -> Void)] = [
            ...
            ("Informational result", { let a=NSAlert(); a.messageText="Harmless information"; a.informativeText="Back or Escape should return."; a.addButton(withTitle:"OK"); self.record("info returned \(host.run(a).rawValue)") }),
    ...
    func confirm() { let a=NSAlert();a.messageText="Harmless confirmation";a.informativeText="Record should finish this dialog without any external action.";a.addButton(withTitle:"Record");a.addButton(withTitle:"Cancel");record("confirmation returned \(SettingsWindow.shared.run(a).rawValue)") }
