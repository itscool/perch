...
- Exercise permission/authorization handoffs, cancellation and return using allowed evidence. Check focus and app/menu tracking; do not infer a working password prompt from a mock. Never read, inject or log credentials during inspection.
