...
subprocess.run(['xcrun','swiftc',str(repo/'Sources/SettingsWindow.swift'),str(repo/'Sources/SettingsAccessibility.swift'),str(repo/'Tools/dialog-lab/main.swift'),'-framework','AppKit','-o',str(app/'Contents/MacOS/PerchDialogLab')],check=True)
