...
func runReviewFixTests() throws {
    ...
    try check(host.pages.last?.title == "Resets" && host.back.title == "Back to Keyboards" && profiles.count == 1, "Offline keyboard reset did not open Resets without changing saved layouts")
