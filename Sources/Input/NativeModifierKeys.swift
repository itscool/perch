...
enum NativeModifierKeys {
    ...
    static func keyboards() -> [NativeKeyboard] {
        ...
        return services.compactMap { service in
            ...
            // createKeyForKeyboard follows the Create rule (+1); taking it unretained leaked one string per keyboard per scan.
            let suffix = formatter?(service)?.takeRetainedValue() as String?
