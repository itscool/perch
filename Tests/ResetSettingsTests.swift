...
func runSettingsResetTests() throws {
    ...
    defaults.set("mapping",forKey:"monitor.inputCycle.v1")
    defaults.set("saved mappings",forKey:"monitor.inputPlans.v1")
    ...
    guard defaults.object(forKey:"monitor.inputCycle.v1") == nil,
          defaults.object(forKey:"monitor.inputPlans.v1") == nil,
    ...
    defaults.set("legacy mappings", forKey:"monitor.inputPlans.v1")
    try SettingsReset.clear(.init(sections:["preferences"]),defaults:defaults,domain:domain,base:base)
    guard defaults.string(forKey:"monitor.inputPlans.v1") == "legacy mappings" else { throw AppError(message:"Preference reset removed device-scoped legacy keys") }
