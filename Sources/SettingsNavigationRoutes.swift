...
extension AppDelegate {
    func installSettingsNavigation() {
        ...
        SettingsWindow.shared.configureNavigation([
            ...
            item("inputs", "Monitor inputs", ["Monitor inputs"], #selector(monitorInputSettings), depth: 1),
            item("groups", "Switching groups", ["Switching groups"], #selector(monitorGroupSettings), depth: 1),
